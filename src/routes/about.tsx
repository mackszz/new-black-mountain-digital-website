...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "About Black Mountain Digital | Canadian Technology Since 1996" },
      { name: "twitter:description", content: "From Canadian telecom roots in 1996 to today's AI, security, and connectivity practice — one accountable partner, three decades of client relationships." },
    ],
