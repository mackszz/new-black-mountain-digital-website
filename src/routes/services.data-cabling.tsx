...
export const Route = createFileRoute("/services/data-cabling")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Structured Cabling Contractor Ontario | Data Cabling Services" },
      { name: "twitter:description", content: "TIA/EIA-certified cabling and fiber install for offices, data centers, and retrofits — tested, documented, warrantied." },
    ],
