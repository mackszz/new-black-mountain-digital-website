...
export const Route = createFileRoute("/services/cx")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "CX & Contact Center Solutions | Black Mountain Digital" },
      { name: "twitter:description", content: "Omnichannel contact center with voice, chat, email, and AI-assist — layered on top of your CRM by a Canadian partner." },
    ],
