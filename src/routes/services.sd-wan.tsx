...
export const Route = createFileRoute("/services/sd-wan")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "SD-WAN Provider for Multi-Site Canadian Businesses" },
      { name: "twitter:description", content: "Managed SD-WAN unifying branches, cloud, and remote workers on one policy-driven network with security, QoS, and failover built in." },
    ],
