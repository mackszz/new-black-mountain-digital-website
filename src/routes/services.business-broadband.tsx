...
export const Route = createFileRoute("/services/business-broadband")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Business Broadband & Internet | Canadian Carrier Services" },
      { name: "twitter:description", content: "Vendor-agnostic business internet with enforceable SLAs, diverse-path failover, and one bill across every Canadian carrier." },
    ],
