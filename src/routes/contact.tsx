...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Contact Black Mountain Digital | Talk to a Canadian Expert" },
      { name: "twitter:description", content: "Reach a Canadian technology specialist. Call, email, or send a message — we respond within one business day, with 24/7 support for existing clients." },
    ],
