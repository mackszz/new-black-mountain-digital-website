...
export const Route = createFileRoute("/services/network-cyber-security")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Network & Cyber Security for Business | Black Mountain Digital" },
      { name: "twitter:description", content: "Managed firewall, endpoint protection, and 24/7 threat monitoring for Canadian businesses — PIPEDA-aligned and owned by a single partner." },
    ],
