...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "One accountable partner for AI, security, voice, connectivity, and cabling — serving Canadian SMBs and mid-market businesses since 1996." },
    ],
