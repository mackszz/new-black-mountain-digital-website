...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Privacy Policy | Black Mountain Digital" },
      { property: "og:description", content: "How Black Mountain Digital collects, uses, and protects personal information under Canadian privacy law (PIPEDA)." },
      { property: "og:url", content: "/privacy" },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_CA" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Privacy Policy | Black Mountain Digital" },
      { name: "twitter:description", content: "How Black Mountain Digital collects, uses, and protects personal information under Canadian privacy law (PIPEDA)." },
